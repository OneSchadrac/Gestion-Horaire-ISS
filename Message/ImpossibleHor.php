                ...
                <div class="card" style="margin-top:40px;">
                    ...
                    <div class="card-body">
                        <form method="POST" action="SaveModificationEnseignant.php" class="needs-validation" enctype="multipart/form-data">
                            <div class="row">
                                <p>Ce cours est déjà alligné pour ce même jour à cette même heure et pour cette même année!.</p>
                            </div>
                            <div>
                                <div>
                                    <hr class="mb-4">
                                    <a class="btn btn-sm btn-secondary  btn-block" href="..\Horaire\ModifierHoraire.php">
                                            D'accord
                                    </a>
                                    </div>
                                </div>
