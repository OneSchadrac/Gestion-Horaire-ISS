<?php
    require('C:\wamp\www\My Project\Gestion des Horaires\Connexion.php' );
...
<body class="text-center">
    <form class="form-signin"    method="post" action="Verifier.php">
        <img class="mb-4" src="../Image/Pers1.png" alt="Tête Homme" width="120" height="120">
...
&nbsp
        ...
        <div class="checkbox mb-3">
            <label>
                <input type="checkbox" value="remember-me"> Me le rappeler
            </label>
        </div>
        <button class="btn btn-lg btn-primary btn-block" type="submit">Valider</button>
        <p class="mt-5 mb-3 text-muted">&copy; ISS/2022-2023</p>
    </form> 
</body>