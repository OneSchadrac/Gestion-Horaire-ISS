...
<body>
       <!-- Barre de Navigation -->
    <nav class="navbar navbar-expand-md navbar-dark bg-dark container-fluid mb-2">
        <div id="navbarCollapse">
            <ul class="nav navbar-nav mr-auto">
                <a href="#" class="navbar-brand">Gestion des Horaires ISS</a>
                ...
                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                    ...
                    <li class="nav-item" style="float:right">
                        <a class="btn btn-sm btn-primary btn-block" class="nav-link" onclick="return confirm('Avez-vous un compte utilisateur \?')" href="../Login/Login.php" >
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form method="GET" action="Horaire.php" class="form-inline">
                        <div class="card-body" style="margin:auto">
                            <div class="row">
                                ...
                                <div class="col-md-1 form-group">
                                    <a href="Horaire.php" class="btn btn-secondary" Style="text-decoration:none;"role="button">
