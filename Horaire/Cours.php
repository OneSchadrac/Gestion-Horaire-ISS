                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <a href="AjouterCours.php" class="btn btn-secondary" Style="text-decoration:none;" role="button"role="button">
                                            <!--icône d'ajout-->
                            ...
                            <tbody>
                                <?php while ($Cours = $res1->fetch()) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <!-- iconne de la modificatiion-->
                                            <a href="EditCours.php?IdCours=<?php echo $Cours['Id_Cours']; ?>" class="btn btn-sm">
                                        ...
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <?php for ($i1 = 1; $i1 <= $NbrePage1; $i1++) { ?>
                                                <li type="button" class="btn btn-outline-dark <?php if ($i1 == $page1) {
                                                    ...
                                                    <a href="Cours.php?page1=<?php echo $i1 ?>" style="text-decoration:none;">
                                                        <?php echo "Page " . $i1; ?>
                                                    </a>
                                                </li>
                                            <?php 
