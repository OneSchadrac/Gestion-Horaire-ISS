...
<body>
       <!-- Barre de Navigation -->
       <?php require('C:\wamp\www\My Project\Gestion des Horaires\Horaire\NavBarreApp.php'); ?>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form method="GET" action="Horaire2.php" class="form-inline">
                        <div class="card-body" style="margin:auto">
                            <div class="row">
                                ...
                                <div class="col-md-1 form-group">
                                    <a href="Horaire2.php?Accueil=1" class="btn btn-secondary" Style="text-decoration:none;"role="button">
